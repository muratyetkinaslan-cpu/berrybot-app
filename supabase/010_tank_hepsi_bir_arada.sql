-- ============================================================
-- 010_TANK_HEPSI_BIR_ARADA.sql
-- TEK SEFERDE ÇALIŞTIR: Supabase → SQL Editor → yapıştır → Run
--
-- İçerik:
--   BÖLÜM A = 36 tank görevi (008)
--   BÖLÜM B = çok-kit progress düzeltmesi + öğrenci onarımı (009)
-- İkisini de daha önce çalıştırdıysan bile güvenle tekrar çalışır.
-- ============================================================
